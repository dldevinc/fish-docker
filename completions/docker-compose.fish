...
complete -c docker-compose -n '__fish_is_first_docker_compose_argument' -fa convert -d "Converts the compose file to platform's canonical format"
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l format -r -d 'Format the output. Values: [yaml | json] (default "yaml")'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l hash -r -d 'Print the service config hash, one per line.'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l images -d 'Print the image names, one per line.'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l no-consistency -d "Don't check model consistency - warning: may produce invalid Compose output"
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l no-interpolate -d "Don't interpolate environment variables."
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l no-normalize -d "Don't normalize compose model."
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l output -s o -r -d 'Save to file (default to stdout)'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l profiles -d 'Print the profile names, one per line.'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l quiet -s q -d "Only validate the configuration, don't print anything."
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l resolve-image-digests -d 'Pin image tags to digests.'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l services -d 'Print the service names, one per line.'
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith convert' -l volumes -d 'Print the volume names, one per line.'
...
complete -c docker-compose -n '__fish_docker_compose_arguments_startswith logs' -l tail -r -d 'Number of lines to show from the end of the logs for each container. (default "all")'
